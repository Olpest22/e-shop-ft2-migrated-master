...
import { useUsernameStore } from '@/app/shared/core/providers/usernameProvider';
    ...
    <header className={s.header}>
      <Container>
        <div className={s.header__content}>
          ...
          {/* Кнопка для КТ#1 — между поиском и wishlist */}
          <button
            onClick={() => setUsername()}
            className="px-3 py-1 rounded-md border border-gray-300 text-sm hover:bg-gray-100 transition-colors"
          >
